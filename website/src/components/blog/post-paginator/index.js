...
import {ArrowLeftIcon} from "../../../custom-theme/icons/arrow-left";
import {ArrowRightIcon} from "../../../custom-theme/icons/arrow-right";

export const PostPaginator = ({ posts }) => {
    const { prevItem, nextItem } = posts;
    return (
